        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-secondary">Manuelle Einladung mit Vor- und Nachname</p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-secondary">Aus WeClapp auswählen und direkt verbinden</p>
            </div>
          </div>
        </div>
      </div>
